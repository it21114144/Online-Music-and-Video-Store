...
<html>
	...
	<link rel = "Stylesheet" href = "styles/stylesx.css">
	...
	<li class = "menu"><a href = "#" > | Home </a> </li>
			...
			<li class = "menu"><a href = "#" > | My Library</a> </li>
			<li class = "menu"><a href = "#" > | Album,Video </a> </li>
			<li class = "menu"><a href = "#" > | Download App </a> </li>
			<li class = "menu"><a href = "#" > | Feedback </a> </li>
	</ul>
	<br>
	
<img  class="profilepic" src = "image\avatar.jpg">
<br>
	...
	<input type = "text" class = "search" placeholder = "Search" >
		...
		<input type="button" class="btn1" value="Profile">
...
<h2>Customer Top Reviews</h2>
 ...
 <div id="container">
<img id="logo3" src="image\dasha.jpg"  align="left"/> <br>
<h3> Dasha Tarran </h3>
</div>
    <style>
            img {
...
<br>
	...
	<!-- 2 -->
	 ...
	 <div id="container">
<img id="logo3" src="image\tom.jpg"  align="left"/> <br>
<h3> Andrew Gray </h3>
</div>
    <style>
            img {
...
<div id="container">
<img id="logo3" src="image\ravn.jpg"  align="left"/> <br>
<h3> Ravn Mue </h3>
</div>
    <style>
            img {
...
<div id="container">
<img id="logo3" src="image\kendall.jpg"  align="left"/> <br>
<h3> Kendall KJ </h3>
</div>
    <style>
            img {
...
<div id="container">
<img id="logo3" src="image\lucus.jpg"  align="left"/> <br>
<h3> Lucus Finch</h3>
</div>
    <style>
            img {
